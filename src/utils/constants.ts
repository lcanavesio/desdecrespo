...
export abstract class Constants {
    static readonly CATEGORIES: Category[] = [
        ...
        // { title: "Salud", databaseName: "Salud", url: "/categoria/salud", icon: LocalHospitalIcon },
        // { title: "Tecnología", databaseName: "Tecnología", url: "/categoria/tecnologia", icon: ComputerIcon },
